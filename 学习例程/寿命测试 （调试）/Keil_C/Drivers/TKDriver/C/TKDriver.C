...
#define      WakeUpKeyChannel                  WakeUpKeyChannel_Set                //低功耗下扫描按键的对应通道
...
//unsigned char  Sensitivity_4mmValue[1][8]={0x03,0x2e,0x04,0x0a,0x21,0x05,0x00,0x9c,};  //4MM 钢化玻璃 01
//unsigned char  Sensitivity_4mmValue[1][8]={0x03,0x2e,0x04,0x08,0x22,0x06,0x00,0xad,};  //4MM 钢化玻璃 02
//unsigned char  Sensitivity_8mmValue[1][8]={0x03,0x2e,0x04,0x1a,0x22,0x05,0x00,0x98,}; // 8mm 微晶玻璃
//unsigned char  Sensitivity_4mmValue[1][8]={0x03,0x2e,0x04,0x0e,0x22,0x05,0x01,0x5f,};  //4MM 钢化玻璃 0628
//unsigned char  Sensitivity_8mmValue[1][8]={0x03,0x2e,0x04,0x10,0x22,0x05,0x00,0xc7,};  // 8mm 微晶玻璃


unsigned char  Sensitivity_4mmValue[1][8]={0x03,0x32,0x04,0x08,0x23,0x05,0x00,0xc6,};      //c6 = 198
unsigned char  Sensitivity_8mmValue[1][8]={0x03,0x2a,0x04,0x10,0x22,0x05,0x00,0xf5,};  // 8mm 微晶玻璃7c
...
*备注	 ：这个返回值的设置， 是根据有多长时间启动TouchKeyRestart（）
...
/**************************************************
*函数名称：void Lowpower_BaselineUpdate(unsigned char i)
*函数功能低功耗基线更新
*入口参数：unsigned char
*出口参数：void  
**************************************************/
