...
#define KEY1	PORT_GetBit(PORT7, PIN2)
#define KEY2	PORT_GetBit(PORT7, PIN0)
#define KEY3	PORT_GetBit(PORT3, PIN0)
#define KEY4	PORT_GetBit(PORT5, PIN0)
...
INT8U Getkey(void)
{
	...
	//if(key==0){key=1;GPIO_Output(PORT2,PIN1,1);}
	//else {key=0;GPIO_Output(PORT2,PIN1,0);}
...
INT8U HkeytoVkey(INT8U Hkey)
{
	...
	switch(Hkey)
	{	
	case 0x01: return VK_RETUN;
	case 0x02: return VK_DOWN;
	case 0x03: return VK_UP;
	
	case 0x04: return VK_SELECT;
