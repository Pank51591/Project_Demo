...
#ifndef	_STC12LE5A60S2_H
#define	_STC12LE5A60S2_H
...
sfr P4SW        =   0xBB;   //X000,XXXX 端口4第二功能寄存器
...
sfr BRT         =   0x9c;   //xxxx,xxxx 串口2数据寄存器
...
#define ISP_CMD_STANDBY	0 //standy模式，待机模式，无ISP操作
#define ISP_CMD_READ	1 //应用程序对EEPROM区字节读模式
#define ISP_CMD_WRITE	2 //应用程序对EEPROM区字节（编程）读模式
#define ISP_CMD_ERASE	3 //应用程序对EEPROM区进行扇区擦除模式

#define ISP_TRIG_5A		0x5A //在ISP_CONTR.7=1时，对ISP_TRIG先写入0x5A再写入0xA5后ISP命令才会生效
#define ISP_TRIG_A5		0xA5


#if 0
#define ISP_EN			B1000_0000
#define ISP_SWBS		B0100_0000
#define ISP_SWRST		B0010_0000
#define ISP_CMD_FAIL	B0001_0000
#define ISP_WAIT_1MHZ	B0000_1111	//cpu等待时间设置
#define ISP_WAIT_2MHZ	B0000_1110
#define ISP_WAIT_3MHZ	B0000_1101
#define ISP_WAIT_6MHZ	B0000_1100
#define ISP_WAIT_12MHZ	B0000_0011  //11.0592M 
#define ISP_WAIT_20MHZ	B0000_1010
#define ISP_WAIT_24MHZ	B0000_1001
#define ISP_WAIT_30MHZ	B0000_1000
#else
#define ISP_EN			(1<<7)
#define ISP_SWBS		(1<<6)
