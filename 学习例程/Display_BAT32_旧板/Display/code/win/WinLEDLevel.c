...
static void WinPageInit(void)
{
	...
	gWinLEDLevel.focus = FOCUS_1;
}

void WinLEDLevelInit(void)
{
	gWinLEDLevel.id = HWND_LEDLevel;
	gWinLEDLevel.item = ITEM_1;
	gWinLEDLevel.focus = FOCUS_1;
	gWinLEDLevel.Init = WinPageInit;
	gWinLEDLevel.WinProc = WinProc;
	
	CreatePage(&gWinLEDLevel);
}
