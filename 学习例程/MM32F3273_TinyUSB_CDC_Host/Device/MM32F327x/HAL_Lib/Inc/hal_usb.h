 ...
 * @{
 */
#define USB_INT_RESET           OTG_FS_INT_STAT_USB_RST        /*!< USB Interrupt: USB bus reset.  */
#define USB_INT_ERROR           OTG_FS_INT_STAT_ERROR          /*!< USB Interrupt: Error happend.  */
#define USB_INT_SOFTOK          OTG_FS_INT_STAT_SOF_TOK        /*!< USB Interrupt: Recv a SOF_Tok. */
#define USB_INT_TOKENDONE       OTG_FS_INT_STAT_TOK_DNE        /*!< USB Interrupt: Token done.     */
#define USB_INT_SLEEP           OTG_FS_INT_STAT_SLEEP          /*!< USB Interrupt: Sleep.          */
#define USB_INT_RESUME          OTG_FS_INT_STAT_RESUME         /*!< USB Interrupt: Resume.         */
#define USB_INT_ATTACH          OTG_FS_INT_STAT_ATTACH         /*!< USB Interrupt: Attach.         */
#define USB_INT_STALL           OTG_FS_INT_STAT_STALL          /*!< USB Interrupt: Stall.          */
/*!
 * @}
 */
 ...
 * @return None.
 */
void USB_EnableEndPointStall(USB_OTG_FS_TypeDef * USBx, uint32_t ep_mask, bool enable);
