...
INT16U TemperatureCompensation(INT16U tds,INT16S temperature)
{
	int temp,k;
...
static uint16_t UserTdsPatch(uint16_t tds)
{
	tds =  ( abs((int)( pow( tds, 6 ) * ( -9.10743592e-19 )\
												+pow( tds, 5 ) * ( 9.59229215e-15 )\
												+pow( tds, 4 ) * ( -3.56474012e-11 )\
												+pow( tds, 3 ) * ( 6.68735645e-08 )\
												+pow( tds, 2 ) * ( -3.97601876e-05 )\
												+tds * ( 1.35904453e-01 )\
												+ 2.82184351e-01 ) )); 									


	tds = TemperatureCompensation(tds,gTDSTemp);
