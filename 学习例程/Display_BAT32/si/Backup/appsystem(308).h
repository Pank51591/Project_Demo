...
#define RO_PowerOnRemained_MAX			(34560*60)//小时
...
#define	STANDBY_longtime			(48*60)//待机长达48小时
#define BACKFLOW_entertime2			(24*60)//进入纯水回流24小时之后	
...
typedef struct
{
	...
	INT8U uartFaucetError:1;//水龙头通讯1异常，0正常
	...
	INT8U uartFaucetTimeOutCnt;//水龙头超时计数
	INT8U uartFaucetTimeOutTime;//

	INT8U pcb_rest_flag;//pcb复位标志
	INT8U ro_rest_flag;//ro复位标志
	INT8U pcb_rest_1hcnt;//pcb复位1小时计数
	INT8U ro_rest_1hcnt;//ro复位1小时计数
}
SYSTEMSETING;
