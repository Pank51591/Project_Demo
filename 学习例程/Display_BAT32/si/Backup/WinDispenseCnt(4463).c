...
static void Update(void)
{
	...
	if(item==ITEM_1)
	{
		...
		{ 
			...
			LcdWriteStrimg(2,0,"                    ");
			snprintf(buf, 20, "%d          ", gUISet.Type[type].Size_DispenseCnt[0]);
	...
	else if(item==ITEM_2)
	{
		...
		else if(focus==FOCUS_1)
		{
			...
			LcdWriteStrimg(2,0,"                    ");
			snprintf(buf, 20, "%d          ", gUISet.Type[type].Size_DispenseCnt[1]);
			LcdWriteStrimg(3,0,buf);		
		}
	}
	else if(item==ITEM_3)
	{
		...
		else if(focus==FOCUS_1)
		{
			...
			LcdWriteStrimg(2,0,"                    ");
			snprintf(buf, 20, "%d          ", gUISet.Type[type].Size_DispenseCnt[2]);
			LcdWriteStrimg(3,0,buf);
		}		
	}
	else if(item==ITEM_4)
	{
		...
		else if(focus==FOCUS_1)
		{
			...
			else 
			{
				...
				LcdWriteStrimg(2,0,"                    ");
				snprintf(buf, 20, "%d          ", gUISet.Type[type].Size_DispenseCnt[3]);
				LcdWriteStrimg(3,0,buf);				
			}
		}		
	}	
