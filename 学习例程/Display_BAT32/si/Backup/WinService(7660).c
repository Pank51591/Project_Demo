...
static const char keyval[15][21]=
{
	"Shaken : Tall       ",
	"Shaken : Grande     ",
	"Shaken : Venti      ",
...
static void Update(void)
{
	...
	gUISet.Service.MainButtonTestVal=0;
	...
	if(item==ITEM_1)
	{
		...
		{
			if(gUISet.Service.MainButtonTestVal&&gUISet.Service.MainButtonTestVal<15)
			{
				LcdWriteStrimg(0,0,keyval[gUISet.Service.MainButtonTestVal-1]);
			}
			else 
			{
				LcdWriteStrimg(0,0,"                    ");
