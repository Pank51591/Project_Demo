...
void FCT_rg_SendData(void)
{
	...
	fct_rg_data.rawTDS_L=25;
	
	if(fctReg.rawTDSRes>8000&&fctReg.rawTDSRes<12000){fct_rg_data.purTDS=20;}//16-36
	...
	fct_rg_data.sfw_Ver=1;//(INT8U)(gReg.version&0x00ff);
...
{
	if(fct_rg_data.FCTstep == 6)
	{
		fct_rg_data.FCTstep=7;
