...
void SC_INT_Init(void)
{
	...
	INT1_SetTriggerMode(0x00|INT16,INT_TRIGGER_FALL_ONLY);     //下降沿触发
	
	INT1_ITConfig(ENABLE,HIGH);       //中断使能
	/*INT_Init write here*/	
}
...
void SC_USCI0_Init(void)
{
	...
	USCI0_UART_Init(32000000,115200,USCI5_UART_Mode_10B,USCI0_UART_RX_ENABLE);
