...
#define BURNER_TIME 40   // 40*10ms=400ms
...
struct Flag_Struct
{
    ...
    unsigned char ModeChange;
		...
		unsigned char FirstBurner1Open;
		unsigned char FirstBurner1Close;
		unsigned char FirstBurner2Open;
		unsigned char FirstBurner2Close;
		unsigned char FirstBurner3Open;
		unsigned char FirstBurner3Close;
		unsigned char FirstBurner4Open;
		unsigned char FirstBurner4Close;
		unsigned char FirstBurner5Open;
		unsigned char FirstBurner5Close;
		unsigned char FirstBurner6Open;
		unsigned char FirstBurner6Close;
		unsigned char IntoTest;
		unsigned char TestKeyDown;
		unsigned char TestKeyReturn;
		unsigned char SendTestAEn;
		unsigned char SendTestBEn;
		unsigned char SendTestCEn;
		unsigned char TestExIR;
		unsigned char LEDON;
		unsigned char JP1;
		unsigned char SendTestA;
		unsigned char SendTestB;
		unsigned char SendTestC;
		unsigned char TestON;
		unsigned char WaitKeyTime;
		unsigned char Wait5s;
		unsigned char TestIROver;
		unsigned char BuzzerTest;
		unsigned char LightOffDelay250ms;
		unsigned char LightOnDelay250ms;
		unsigned char ToBurnerOpen;
};  
...
#define Set_AllHodCloseFlag     MyFlag.AllHodClose = 1
...
#define FirstBurner1OpenFlag       MyFlag.FirstBurner1Open
#define Set_FirstBurner1OpenFlag   MyFlag.FirstBurner1Open  = 1
#define Clr_FirstBurner1OpenFlag   MyFlag.FirstBurner1Open  = 0

#define FirstBurner1CloseFlag       MyFlag.FirstBurner1Close
#define Set_FirstBurner1CloseFlag   MyFlag.FirstBurner1Close  = 1
#define Clr_FirstBurner1CloseFlag   MyFlag.FirstBurner1Close  = 0

#define FirstBurner2OpenFlag       MyFlag.FirstBurner2Open
#define Set_FirstBurner2OpenFlag   MyFlag.FirstBurner2Open  = 1
#define Clr_FirstBurner2OpenFlag   MyFlag.FirstBurner2Open  = 0

#define FirstBurner2CloseFlag       MyFlag.FirstBurner2Close
#define Set_FirstBurner2CloseFlag   MyFlag.FirstBurner2Close  = 1
#define Clr_FirstBurner2CloseFlag   MyFlag.FirstBurner2Close  = 0

#define FirstBurner3OpenFlag       MyFlag.FirstBurner3Open
#define Set_FirstBurner3OpenFlag   MyFlag.FirstBurner3Open  = 1
#define Clr_FirstBurner3OpenFlag   MyFlag.FirstBurner3Open  = 0

#define FirstBurner3CloseFlag       MyFlag.FirstBurner3Close
#define Set_FirstBurner3CloseFlag   MyFlag.FirstBurner3Close  = 1
#define Clr_FirstBurner3CloseFlag   MyFlag.FirstBurner3Close  = 0

#define FirstBurner4OpenFlag       MyFlag.FirstBurner4Open
#define Set_FirstBurner4OpenFlag   MyFlag.FirstBurner4Open  = 1
#define Clr_FirstBurner4OpenFlag   MyFlag.FirstBurner4Open  = 0

#define FirstBurner4CloseFlag       MyFlag.FirstBurner4Close
#define Set_FirstBurner4CloseFlag   MyFlag.FirstBurner4Close  = 1
#define Clr_FirstBurner4CloseFlag   MyFlag.FirstBurner4Close  = 0

#define FirstBurner5OpenFlag       MyFlag.FirstBurner5Open
#define Set_FirstBurner5OpenFlag   MyFlag.FirstBurner5Open  = 1
#define Clr_FirstBurner5OpenFlag   MyFlag.FirstBurner5Open  = 0

#define FirstBurner5CloseFlag       MyFlag.FirstBurner5Close
#define Set_FirstBurner5CloseFlag   MyFlag.FirstBurner5Close  = 1
#define Clr_FirstBurner5CloseFlag   MyFlag.FirstBurner5Close  = 0

#define FirstBurner6OpenFlag       MyFlag.FirstBurner6Open
#define Set_FirstBurner6OpenFlag   MyFlag.FirstBurner6Open  = 1
#define Clr_FirstBurner6OpenFlag   MyFlag.FirstBurner6Open  = 0

#define FirstBurner6CloseFlag       MyFlag.FirstBurner6Close
#define Set_FirstBurner6CloseFlag   MyFlag.FirstBurner6Close  = 1
#define Clr_FirstBurner6CloseFlag   MyFlag.FirstBurner6Close  = 0

#define IntoTestFlag         MyFlag.IntoTest
#define Set_IntoTestFlag     MyFlag.IntoTest = 1
#define Clr_IntoTestFlag     MyFlag.IntoTest = 0

#define TestKeyDownFlag      MyFlag.TestKeyDown
#define Set_TestKeyDownFlag      MyFlag.TestKeyDown = 1
#define Clr_TestKeyDownFlag      MyFlag.TestKeyDown = 0

#define TestKeyReturnFlag     MyFlag.TestKeyReturn
#define Set_TestKeyReturnFlag   MyFlag.TestKeyReturn = 1
#define Clr_TestKeyReturnFlag   MyFlag.TestKeyReturn = 0

#define SendTestAEnFlag      MyFlag.SendTestAEn
#define Set_SendTestAEnFlag      MyFlag.SendTestAEn = 1
#define Clr_SendTestAEnFlag      MyFlag.SendTestAEn = 0

#define SendTestBEnFlag      MyFlag.SendTestBEn
#define Set_SendTestBEnFlag      MyFlag.SendTestBEn = 1
#define Clr_SendTestBEnFlag      MyFlag.SendTestBEn = 0

#define SendTestCEnFlag      MyFlag.SendTestCEn
#define Set_SendTestCEnFlag      MyFlag.SendTestCEn = 1
#define Clr_SendTestCEnFlag      MyFlag.SendTestCEn = 0

#define TestExIRFlag     MyFlag.TestExIR
#define Set_TestExIRFlag    MyFlag.TestExIR = 1
#define Clr_TestExIRFlag    MyFlag.TestExIR = 0

#define LEDONFlag    MyFlag.LEDON
#define Set_LEDONFlag   MyFlag.LEDON = 1
#define Clr_LEDONFlag   MyFlag.LEDON = 0

#define JP1Flag     MyFlag.JP1
#define Set_JP1Flag    MyFlag.JP1 = 1
#define Clr_JP1Flag    MyFlag.JP1 = 0

#define SendTestAFlag     MyFlag.SendTestA
#define Set_SendTestAFlag      MyFlag.SendTestA = 1
#define Clr_SendTestAFlag      MyFlag.SendTestA = 0

#define SendTestBFlag     MyFlag.SendTestB
#define Set_SendTestBFlag      MyFlag.SendTestB = 1
#define Clr_SendTestBFlag      MyFlag.SendTestB = 0

#define SendTestCFlag     MyFlag.SendTestC
#define Set_SendTestCFlag      MyFlag.SendTestC = 1
#define Clr_SendTestCFlag      MyFlag.SendTestC = 0

#define TestONFlag    MyFlag.TestON
#define Set_TestONFlag  MyFlag.TestON = 1
#define Clr_TestONFlag  MyFlag.TestON = 0

#define WaitKeyTimeFlag  MyFlag.WaitKeyTime
#define Set_WaitKeyTimeFlag  MyFlag.WaitKeyTime = 1
#define Clr_WaitKeyTimeFlag  MyFlag.WaitKeyTime = 0

#define Wait5sFlag       MyFlag.Wait5s
#define Set_Wait5sFlag   MyFlag.Wait5s = 1
#define Clr_Wait5sFlag   MyFlag.Wait5s = 0

#define TestIROverFlag      MyFlag.TestIROver
#define Set_TestIROverFlag  MyFlag.TestIROver = 1
#define Clr_TestIROverFlag  MyFlag.TestIROver = 0

#define BuzzerTestFlag       MyFlag.BuzzerTest
#define Set_BuzzerTestFlag   MyFlag.BuzzerTest = 1
#define Clr_BuzzerTestFlag   MyFlag.BuzzerTest = 0

#define LightOffDelay250ms_Flag        MyFlag.LightOffDelay250ms
#define Set_LightOffDelay250ms_Flag    MyFlag.LightOffDelay250ms = 1
#define Clr_LightOffDelay250ms_Flag    MyFlag.LightOffDelay250ms = 0

#define LightOnDelay250ms_Flag         MyFlag.LightOnDelay250ms
#define Set_LightOnDelay250ms_Flag     MyFlag.LightOnDelay250ms = 1
#define Clr_LightOnDelay250ms_Flag     MyFlag.LightOnDelay250ms = 0

#define ToBurnerOpen_Flag         MyFlag.ToBurnerOpen
#define Set_ToBurnerOpen_Flag     MyFlag.ToBurnerOpen = 1
#define Clr_ToBurnerOpen_Flag     MyFlag.ToBurnerOpen = 0
