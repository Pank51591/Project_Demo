...
/**
  * @brief  Returns the frequencies of different on chip clocks. 返回不同片上时钟频率
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
  ...
  /* Compute HCLK, PCLK1, PCLK2 and ADCCLK clocks frequencies 计算 HCLK、PCLK1、PCLK2 和 ADCCLK 时钟频率----------------*/
  /* Get HCLK prescaler */
...
/**
  * @brief  Enables or disables the AHB peripheral clock.  AHB外设时钟
