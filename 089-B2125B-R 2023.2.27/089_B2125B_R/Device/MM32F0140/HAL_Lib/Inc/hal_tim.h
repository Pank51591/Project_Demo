...
/// @anchor TIM_Master_Slave_Mode
typedef enum {
    TIM_IT_Update  = TIM_DIER_UI,                               ///< TIM update Interrupt source   TIM更新中断源
    TIM_IT_CC1     = TIM_DIER_CC1I,                             ///< TIM Capture Compare 1 Interrupt source   TIM捕获比较1中断源
    ...
    TIM_IT_COM     = TIM_DIER_COMI,                             ///< TIM Commutation Interrupt source  TIM换向中断源
    TIM_IT_Trigger = TIM_DIER_TI,                               ///< TIM Trigger Interrupt source    TIM触发中断源
    TIM_IT_Break   = TIM_DIER_BI,                                ///< TIM Break Interrupt source   TIM休息中断源
...
/// @anchor TIM_Flags
typedef enum {
    TIM_FLAG_Update  = TIM_SR_UI,                              ///< TIM update Flag  TIM更新标志 
