...
#define USART_IT_LBD                         ((uint16_t)0x0846)      //LIN中断探测中断
#define USART_IT_CTS                         ((uint16_t)0x096A)      //CTS中断
#define USART_IT_ERR                         ((uint16_t)0x0060)      //错误中断
#define USART_IT_ORE                         ((uint16_t)0x0360)      //溢出错误中断
#define USART_IT_NE                          ((uint16_t)0x0260)      //噪音中断
...
#define USART_FLAG_CTS                       ((uint16_t)0x0200)         //CTS标志位
#define USART_FLAG_LBD                       ((uint16_t)0x0100)         //LIN中断检测标志位
#define USART_FLAG_TXE                       ((uint16_t)0x0080)         //发送数据寄存器空标志位
#define USART_FLAG_TC                        ((uint16_t)0x0040)         //发送完成标志位
