...
void hal_entry(void)
{
    ...
    /* LED2：配置引脚 P404 对应的PFS寄存器 */
    R_PFS->PORT[BSP_IO_PORT_04_PIN_04>>8].PIN[BSP_IO_PORT_04_PIN_04 & 0xFF].PmnPFS =
        IOPORT_CFG_PORT_DIRECTION_OUTPUT | IOPORT_CFG_PORT_OUTPUT_LOW;
    /* LED3：配置引脚 P405 对应的PFS寄存器 */
    R_PFS->PORT[BSP_IO_PORT_04_PIN_05>>8].PIN[BSP_IO_PORT_04_PIN_05 & 0xFF].PmnPFS =
        IOPORT_CFG_PORT_DIRECTION_OUTPUT | IOPORT_CFG_PORT_OUTPUT_LOW;
    ...
    {
        /* 翻转LED灯：LED1 */
        //R_PORT4->PODR |= 1<<(BSP_IO_PORT_04_PIN_03 & 0xFF);
        //R_BSP_SoftwareDelay(1000, BSP_DELAY_UNITS_MILLISECONDS);
        //R_PORT4->PODR &= (uint16_t)~(1 << (BSP_IO_PORT_04_PIN_03 & 0xFF));
        //R_BSP_SoftwareDelay(1000, BSP_DELAY_UNITS_MILLISECONDS);
