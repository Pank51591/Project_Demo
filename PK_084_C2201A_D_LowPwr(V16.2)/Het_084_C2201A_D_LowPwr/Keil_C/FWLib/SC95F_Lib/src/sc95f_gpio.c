...
{
#if defined(SC95F8x1x) || defined(SC95F7x1x) || defined(SC92FWxx) || defined(SC95F8x3x) || defined(SC95F7x3x) || defined (SC95F8x6x) || defined (SC95F7x6x)  || defined (SC95F8x1xB) || defined (SC95F7x1xB)
  P0CON = 0x00;
  P1CON = 0x00;
  P2CON = 0x00;
  P3CON = 0x00;
